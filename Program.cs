...
namespace AddressBook
{
    public class Program
    {
        ...
        // 1. Add the required classes to make the following code compile.
            // public class Contact --> Place in it's own class .cs file
            // public class AddressBook --> Place in it's own class .cs file
...
// _contactList.Add();
        static void Main(string[] args)
        {
            ...
            // email is a single string and emails is the list its looping through
